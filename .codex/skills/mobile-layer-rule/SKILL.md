...
This Codex skill adapts `mobile-engineer/architecture/layer-rule.md` into Codex skill guidance while preserving the source rules for production fintech development.
