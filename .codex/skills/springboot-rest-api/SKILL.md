...
This Codex skill adapts `backend-engineer/springboot/rest-api-standard.md` into Codex skill guidance while preserving the source rules for production fintech development.
