...
This Codex skill adapts `backend-engineer/engineering/clean-code.md` into Codex skill guidance while preserving the source rules for production fintech development.
