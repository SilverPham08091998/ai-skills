...
This Codex skill adapts `backend-engineer/java/collections.md` into Codex skill guidance while preserving the source rules for production fintech development.
