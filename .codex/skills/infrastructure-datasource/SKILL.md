...
This Codex skill adapts `backend-engineer/infrastructure/data-source.md` into Codex skill guidance while preserving the source rules for production fintech development.
