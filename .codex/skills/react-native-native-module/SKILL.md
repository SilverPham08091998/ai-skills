...
This Codex skill adapts `mobile-engineer/react-native/native-module-rule.md` into Codex skill guidance while preserving the source rules for production fintech development.
