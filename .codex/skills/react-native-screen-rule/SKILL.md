...
This Codex skill adapts `mobile-engineer/react-native/screen-rule.md` into Codex skill guidance while preserving the source rules for production fintech development.
