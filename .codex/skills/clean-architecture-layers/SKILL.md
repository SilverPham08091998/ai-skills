...
This Codex skill adapts `backend-engineer/clean-architecture/layers.md` into Codex skill guidance while preserving the source rules for production fintech development.
...
# .codex/guidelines/clean-architecture/layers.md
