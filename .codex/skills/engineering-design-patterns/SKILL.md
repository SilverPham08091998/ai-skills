...
This Codex skill adapts `backend-engineer/engineering/design-patterns.md` into Codex skill guidance while preserving the source rules for production fintech development.
