...
This Codex skill adapts `mobile-engineer/foundation/design-patterns.md` into Codex skill guidance while preserving the source rules for production fintech development.
