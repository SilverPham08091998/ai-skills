...
This Codex skill adapts `mobile-engineer/state-management/redux-persist.md` into Codex skill guidance while preserving the source rules for production fintech development.
