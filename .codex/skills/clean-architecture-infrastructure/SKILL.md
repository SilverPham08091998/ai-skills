...
This Codex skill adapts `backend-engineer/clean-architecture/infrastructure-rule.md` into Codex skill guidance while preserving the source rules for production fintech development.
