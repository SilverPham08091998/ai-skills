...
This Codex skill adapts `backend-engineer/microservice-pattern/master-slave.md` into Codex skill guidance while preserving the source rules for production fintech development.
