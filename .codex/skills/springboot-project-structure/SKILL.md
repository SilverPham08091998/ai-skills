...
This Codex skill adapts `backend-engineer/springboot/project-structure.md` into Codex skill guidance while preserving the source rules for production fintech development.
