...
This Codex skill adapts `backend-engineer/java/concurrency.md` into Codex skill guidance while preserving the source rules for production fintech development.
