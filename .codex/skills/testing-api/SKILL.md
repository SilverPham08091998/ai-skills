...
This Codex skill adapts `backend-engineer/testing/api-testing.md` into Codex skill guidance while preserving the source rules for production fintech development.
