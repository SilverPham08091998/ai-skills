...
This Codex skill adapts `mobile-engineer/architecture/mobile-architecture.md` into Codex skill guidance while preserving the source rules for production fintech development.
