...
This Codex skill adapts `backend-engineer/engineering/coding-principles.md` into Codex skill guidance while preserving the source rules for production fintech development.
