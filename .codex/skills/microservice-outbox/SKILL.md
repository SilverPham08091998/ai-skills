...
This Codex skill adapts `backend-engineer/microservice-pattern/outbox.md` into Codex skill guidance while preserving the source rules for production fintech development.
