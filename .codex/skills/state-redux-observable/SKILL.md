...
This Codex skill adapts `mobile-engineer/state-management/redux-observable.md` into Codex skill guidance while preserving the source rules for production fintech development.
