...
Trước khi phân tích hoặc thay đổi bất cứ điều gì, Codex và user phải align rõ về target refactor, lý do, sub-type, và scope.
...
Codex phải xác định sub-type từ yêu cầu user:
