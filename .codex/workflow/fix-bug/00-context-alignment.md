...
Trước khi reproduce hoặc fix bất cứ điều gì, Codex và user phải align đầy đủ về bug: điều kiện, môi trường, impact, và kỳ vọng.
...
Codex phải hỏi hoặc tự tìm đủ các thông tin sau:
...
Trước khi reproduce, Codex phải tóm tắt lại:
...
Codex phải xác nhận với user trước khi qua Step 01:
