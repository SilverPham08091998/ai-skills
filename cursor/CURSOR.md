# CURSOR.md — Engineering Agent System Contract
...
* AI coding agents (Cursor / GPT / internal generators)
...
* Cursor work launched from any project folder
...
Cursor may be invoked from any project folder. In that case:

* The ai-skills repository is the **rule root**
* The user's current project is the **target project**
* Cursor reads `cursor/` rules, workflows, commands, templates, and skills from the rule root
* Cursor edits and validates files in the target project
...
4. Current repository root, only if it contains `cursor/CURSOR.md`
...
Before implementing any code, refactor, generated artifact, or repository rule update, Cursor MUST:
...
Files already listed in an approved TODO/file scope may be edited without asking again. After approval, Cursor must continue task-by-task without repeated yes/no confirmations unless there is a real blocker, validation failure, or required out-of-scope file change.
...
If a required edit is outside the approved TODO/file list, Cursor MUST stop and ask first:
...
1. `<ai-skills-rule-root>/cursor/workflow/implement/00-context-alignment.md`
2. `<ai-skills-rule-root>/cursor/workflow/implement/01-architecture.md`
3. `<ai-skills-rule-root>/cursor/workflow/implement/02-structure-check.md`
4. `<ai-skills-rule-root>/cursor/workflow/implement/03-task-breakdown.md`
5. `<ai-skills-rule-root>/cursor/workflow/implement/04-coding.md`
6. `<ai-skills-rule-root>/cursor/workflow/implement/05-unit-tests.md`
7. `<ai-skills-rule-root>/cursor/workflow/implement/06-coverage.md`
8. `<ai-skills-rule-root>/cursor/workflow/implement/07-version-guide.md`
9. `<ai-skills-rule-root>/cursor/workflow/implement/08-pre-commit.md`
...
1. `<ai-skills-rule-root>/cursor/workflow/ask.md`
...
1. `<ai-skills-rule-root>/cursor/workflow/fix-bug/00-context-alignment.md`
2. `<ai-skills-rule-root>/cursor/workflow/fix-bug/01-reproduce.md`
3. `<ai-skills-rule-root>/cursor/workflow/fix-bug/02-root-cause.md`
4. `<ai-skills-rule-root>/cursor/workflow/fix-bug/03-impact-analysis.md`
5. `<ai-skills-rule-root>/cursor/workflow/fix-bug/04-fix.md`
6. `<ai-skills-rule-root>/cursor/workflow/fix-bug/05-verify.md`
7. `<ai-skills-rule-root>/cursor/workflow/fix-bug/06-pre-commit.md`
...
1. `<ai-skills-rule-root>/cursor/workflow/refactor/00-context-alignment.md`
2. `<ai-skills-rule-root>/cursor/workflow/refactor/01-behavior-baseline.md`
3. `<ai-skills-rule-root>/cursor/workflow/refactor/02-analysis.md`
4. `<ai-skills-rule-root>/cursor/workflow/refactor/03-refactor-plan.md`
5. `<ai-skills-rule-root>/cursor/workflow/refactor/04-coding.md`
6. `<ai-skills-rule-root>/cursor/workflow/refactor/05-verify.md`
7. `<ai-skills-rule-root>/cursor/workflow/refactor/06-pre-commit.md`
...
1. `<ai-skills-rule-root>/cursor/workflow/review/00-context-alignment.md`
2. `<ai-skills-rule-root>/cursor/workflow/review/01-collect.md`
3. `<ai-skills-rule-root>/cursor/workflow/review/02-analyze.md`
4. `<ai-skills-rule-root>/cursor/workflow/review/03-report.md`
5. `<ai-skills-rule-root>/cursor/workflow/review/04-fix-suggestions.md`
...
1. `<ai-skills-rule-root>/cursor/workflow/router.md`
