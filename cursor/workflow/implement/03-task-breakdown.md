...
Sau khi đã có context, architecture, file scope, và Applied Skill Contract, Cursor phải break work thành task list chi tiết trước khi code.
...
After the user approves the TODO/file scope, Cursor should proceed continuously through approved tasks without asking repeated yes/no questions.

During implementation, Cursor should update task status as work progresses:
