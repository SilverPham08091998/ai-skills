...
Trước khi reproduce hoặc fix bất cứ điều gì, Cursor và user phải align đầy đủ về bug: điều kiện, môi trường, impact, và kỳ vọng.
...
Cursor phải hỏi hoặc tự tìm đủ các thông tin sau:
...
Trước khi reproduce, Cursor phải tóm tắt lại:
...
Cursor phải xác nhận với user trước khi qua Step 01:
