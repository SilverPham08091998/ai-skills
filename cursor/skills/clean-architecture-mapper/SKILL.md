---
name: clean-architecture-mapper
description: Mapper rules for Clean Architecture backend services. Use when converting between request DTOs, commands, domain models, entities, and responses.
---

# Clean Architecture Mapper Guidelines

This Cursor skill adapts `backend-engineer/clean-architecture/mapper-rule.md` into Cursor skill guidance while preserving the source rules for production fintech development.
...
# cursor/guidelines/clean-architecture/mapper-rule.md
