...
This Cursor skill adapts `mobile-engineer/architecture/navigation-rule.md` into Cursor skill guidance while preserving the source rules for production fintech development.
