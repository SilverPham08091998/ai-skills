...
description: Infrastructure-layer rules for Clean Architecture backend services. Use when implementing persistence, external clients, messaging, cache, or framework adapters.
---

# Clean Architecture Infrastructure Guidelines

This Cursor skill adapts `backend-engineer/clean-architecture/infrastructure-rule.md` into Cursor skill guidance while preserving the source rules for production fintech development.
...
# cursor/guidelines/clean-architecture/infrastructure-rule.md
