...
This Cursor skill adapts `mobile-engineer/state-management/token-management.md` into Cursor skill guidance while preserving the source rules for production fintech development.
