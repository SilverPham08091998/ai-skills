...
This Cursor skill adapts `mobile-engineer/react-native/component-rule.md` into Cursor skill guidance while preserving the source rules for production fintech development.
