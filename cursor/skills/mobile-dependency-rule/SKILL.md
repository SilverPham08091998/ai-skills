...
This Cursor skill adapts `mobile-engineer/architecture/dependency-rule.md` into Cursor skill guidance while preserving the source rules for production fintech development.
