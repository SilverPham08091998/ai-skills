...
This Cursor skill adapts `backend-engineer/infrastructure/data-source.md` into Cursor skill guidance while preserving the source rules for production fintech development.
