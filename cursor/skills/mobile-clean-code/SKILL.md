...
This Cursor skill adapts `mobile-engineer/foundation/clean-code.md` into Cursor skill guidance while preserving the source rules for production fintech development.
