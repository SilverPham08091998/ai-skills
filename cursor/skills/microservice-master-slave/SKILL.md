...
This Cursor skill adapts `backend-engineer/microservice-pattern/master-slave.md` into Cursor skill guidance while preserving the source rules for production fintech development.
