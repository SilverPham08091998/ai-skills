...
This Cursor skill adapts `backend-engineer/springboot/tracing.md` into Cursor skill guidance while preserving the source rules for production fintech development.
