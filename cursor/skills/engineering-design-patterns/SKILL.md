...
This Cursor skill adapts `backend-engineer/engineering/design-patterns.md` into Cursor skill guidance while preserving the source rules for production fintech development.
