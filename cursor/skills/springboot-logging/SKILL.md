...
This Cursor skill adapts `backend-engineer/springboot/logging.md` into Cursor skill guidance while preserving the source rules for production fintech development.
