...
- Claude Code -> **4.a**
- Copilot CLI -> **4.b**
- Cursor, Gemini CLI, or Cursor -> **4.c**
...
#### 4.c — Cursor, Gemini CLI, and Cursor
...
Confirm that integration is ready — the MCP server will start automatically when the agent reads its config (`mcp.json` for Cursor, and Cursor; `gemini-extension.json` for Gemini CLI).
