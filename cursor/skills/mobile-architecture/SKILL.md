...
This Cursor skill adapts `mobile-engineer/architecture/mobile-architecture.md` into Cursor skill guidance while preserving the source rules for production fintech development.
