...
This Cursor skill adapts `backend-engineer/code-review/pr-checklist.md` into Cursor skill guidance while preserving the source rules for production fintech development.
