...
This Cursor skill adapts `backend-engineer/code-review/backend-review.md` into Cursor skill guidance while preserving the source rules for production fintech development.
