...
This Cursor skill adapts `backend-engineer/java/performance.md` into Cursor skill guidance while preserving the source rules for production fintech development.
