...
This Cursor skill adapts `backend-engineer/engineering/coding-principles.md` into Cursor skill guidance while preserving the source rules for production fintech development.
