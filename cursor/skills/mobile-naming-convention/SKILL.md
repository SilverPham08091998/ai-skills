...
This Cursor skill adapts `mobile-engineer/foundation/naming-convention.md` into Cursor skill guidance while preserving the source rules for production fintech development.
