...
This Cursor skill adapts `backend-engineer/clean-architecture/common.md` into Cursor skill guidance while preserving the source rules for production fintech development.
...
# cursor/guidelines/clean-architecture/common.md
