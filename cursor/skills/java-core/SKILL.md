...
This Cursor skill adapts `backend-engineer/java/java-core.md` into Cursor skill guidance while preserving the source rules for production fintech development.
