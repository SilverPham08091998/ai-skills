...
This Cursor skill adapts `backend-engineer/testing/e2e-testing.md` into Cursor skill guidance while preserving the source rules for production fintech development.
