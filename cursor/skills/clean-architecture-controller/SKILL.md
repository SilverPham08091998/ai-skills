...
description: Controller-layer rules for Clean Architecture backend services. Use when writing REST, Kafka, gRPC, or other entry-point adapters.
---

# Clean Architecture Controller Guidelines

This Cursor skill adapts `backend-engineer/clean-architecture/controller-rule.md` into Cursor skill guidance while preserving the source rules for production fintech development.
...
# cursor/guidelines/clean-architecture/controller-rule.md
