...
This Cursor skill adapts `mobile-engineer/state-management/redux-saga.md` into Cursor skill guidance while preserving the source rules for production fintech development.
