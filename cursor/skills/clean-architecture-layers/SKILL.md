...
This Cursor skill adapts `backend-engineer/clean-architecture/layers.md` into Cursor skill guidance while preserving the source rules for production fintech development.
...
# cursor/guidelines/clean-architecture/layers.md
