...
Trước khi commit code, Claude phải verify lại test/build/coverage, kiểm tra branch an toàn, và chuẩn bị commit message/body đúng format.
...
```text
feature/dev/device-management
bug/dev/fix-binding-expire
chore/dev/update-workflow
docs/dev/version-guide
```
...
```text
[DEV][FEATURE][VSP-9876] add device-management-service
[DEV][BUG][VSP-9876] fix binding request expire logic
