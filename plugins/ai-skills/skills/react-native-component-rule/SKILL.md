...
This skill converts `mobile-engineer/react-native/component-rule.md` into Claude Code plugin skill guidance while preserving the source rules for production fintech development.
