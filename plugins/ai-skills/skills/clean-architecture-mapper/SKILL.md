...
This skill converts `backend-engineer/clean-architecture/mapper-rule.md` into Claude Code plugin skill guidance while preserving the source rules for production fintech development.
