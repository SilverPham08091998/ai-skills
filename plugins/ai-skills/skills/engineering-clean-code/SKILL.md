...
description: Clean code standards for backend engineering. Use when writing or reviewing readable, maintainable, production-grade code.
---

# Engineering Clean Code Guidelines

This skill converts `backend-engineer/engineering/clean-code.md` into Claude Code plugin skill guidance while preserving the source rules for production fintech development.
