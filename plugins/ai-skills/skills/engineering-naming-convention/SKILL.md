---
name: engineering-naming-convention
description: Backend naming conventions for packages, classes, methods, variables, APIs, and database artifacts. Use when naming code or reviewing consistency.
---

# Engineering Naming Convention Guidelines

This skill converts `backend-engineer/engineering/naming-convention.md` into Claude Code plugin skill guidance while preserving the source rules for production fintech development.
