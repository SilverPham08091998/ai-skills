---
name: mobile-navigation-rule
description: Mobile navigation rules for React Native apps. Use when implementing navigation stacks, params, guards, and screen transitions.
---

# Mobile Navigation Rule Guidelines

This skill converts `mobile-engineer/architecture/navigation-rule.md` into Claude Code plugin skill guidance while preserving the source rules for production fintech development.
