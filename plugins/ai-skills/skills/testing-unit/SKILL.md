...
This skill converts `backend-engineer/testing/unit-test.md` into Claude Code plugin skill guidance while preserving the source rules for production fintech development.
