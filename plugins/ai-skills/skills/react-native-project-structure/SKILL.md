...
description: React Native project structure standards. Use when creating or organizing source folders, features, shared modules, and infrastructure code.
---

# React Native Project Structure Guidelines

This skill converts `mobile-engineer/react-native/project-structure.md` into Claude Code plugin skill guidance while preserving the source rules for production fintech development.
