...
This skill converts `mobile-engineer/foundation/coding-principles.md` into Claude Code plugin skill guidance while preserving the source rules for production fintech development.
