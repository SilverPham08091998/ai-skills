...
This skill converts `backend-engineer/code-review/backend-review.md` into Claude Code plugin skill guidance while preserving the source rules for production fintech development.
