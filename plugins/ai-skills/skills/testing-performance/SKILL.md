...
description: Performance testing standards for backend systems. Use when defining load, stress, latency, throughput, and capacity validation.
---

# Testing Performance Guidelines

This skill converts `backend-engineer/testing/performance-testing.md` into Claude Code plugin skill guidance while preserving the source rules for production fintech development.
