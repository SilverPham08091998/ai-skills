...
description: Spring Boot security standards. Use when implementing authentication, authorization, token handling, secure endpoints, and fintech-safe controls.
---

# Spring Boot Security Guidelines

This skill converts `backend-engineer/springboot/security.md` into Claude Code plugin skill guidance while preserving the source rules for production fintech development.
