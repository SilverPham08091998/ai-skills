...
This skill converts `backend-engineer/springboot/project-structure.md` into Claude Code plugin skill guidance while preserving the source rules for production fintech development.
