---
name: react-native-native-module
description: React Native native module rules. Use when integrating iOS or Android native capabilities behind safe TypeScript abstractions.
---

# React Native Native Module Guidelines

This skill converts `mobile-engineer/react-native/native-module-rule.md` into Claude Code plugin skill guidance while preserving the source rules for production fintech development.
