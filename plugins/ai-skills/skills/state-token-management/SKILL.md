...
This skill converts `mobile-engineer/state-management/token-management.md` into Claude Code plugin skill guidance while preserving the source rules for production fintech development.
