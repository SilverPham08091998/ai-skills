...
description: Mobile architecture standards for fintech React Native apps. Use when designing feature boundaries, layers, dependencies, and application flow.
---

# Mobile Architecture Guidelines

This skill converts `mobile-engineer/architecture/mobile-architecture.md` into Claude Code plugin skill guidance while preserving the source rules for production fintech development.
