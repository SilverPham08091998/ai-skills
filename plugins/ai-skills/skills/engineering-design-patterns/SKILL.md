...
description: Backend design pattern guidance for production services. Use when choosing or reviewing patterns for maintainable Java and Spring code.
---

# Engineering Design Patterns Guidelines

This skill converts `backend-engineer/engineering/design-patterns.md` into Claude Code plugin skill guidance while preserving the source rules for production fintech development.
