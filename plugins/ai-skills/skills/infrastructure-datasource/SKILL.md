---
name: infrastructure-datasource
description: Data source infrastructure standards for backend services. Use when configuring databases, repositories, transactions, pooling, or read/write data access.
---

# Infrastructure Datasource Guidelines

This skill converts `backend-engineer/infrastructure/data-source.md` into Claude Code plugin skill guidance while preserving the source rules for production fintech development.
