...
This skill converts `backend-engineer/microservice-pattern/outbox.md` into Claude Code plugin skill guidance while preserving the source rules for production fintech development.
