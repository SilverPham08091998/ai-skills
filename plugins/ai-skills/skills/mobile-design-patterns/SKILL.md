...
This skill converts `mobile-engineer/foundation/design-patterns.md` into Claude Code plugin skill guidance while preserving the source rules for production fintech development.
