---
name: state-redux-persist
description: Redux Persist standards for mobile apps. Use when persisting non-sensitive UI state safely and defining persist allowlists.
---

# State REDUX Persist Guidelines

This skill converts `mobile-engineer/state-management/redux-persist.md` into Claude Code plugin skill guidance while preserving the source rules for production fintech development.
