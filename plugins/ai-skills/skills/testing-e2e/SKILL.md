...
This skill converts `backend-engineer/testing/e2e-testing.md` into Claude Code plugin skill guidance while preserving the source rules for production fintech development.
